...
---------------------------> TRIM station name to ensure no extra space, and to replace (*), (Temp), filter 
out row with(LBS-WH-TEST) in start station name <------------------
...
---------------------------> TRIM station name to ensure no extra space, and to replace (*), (Temp), filter 
out row with(LBS-WH-TEST) in end station name <------------------
...
------------------------------------
---------------------------> 1. Find out total numbers of member or casual riders DEPARTING from 
respective stations <---------------------------------
...
---------------------------> 2. Find out total numbers of member or casual riders ARRIVING for respective 
stations <----------------------------------
...
arrive_latlng AS
(
SELECT DISTINCT end_station_name_clean, ROUND(AVG(end_lat),4) AS arr_lat, 
...
---------------------------------> 3. To find out trips taken by casual & members respectively group by the 
DAY OF THE WEEK <-------------------------------------------
